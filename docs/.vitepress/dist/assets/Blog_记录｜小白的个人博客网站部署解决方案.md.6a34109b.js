...
<span class="line"><span style="color:#24292e;">git push -u origin master</span></span></code></pre></div><h3 id="一些可能的部署问题" tabindex="-1">一些可能的部署问题 <a class="header-anchor" href="#一些可能的部署问题" aria-label="Permalink to &quot;一些可能的部署问题&quot;">​</a></h3><ol><li>MacOS碰到的访问权限问题：</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">git@github.com: Permission denied (publickey).</span></span>
